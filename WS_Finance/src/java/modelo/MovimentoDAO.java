...
public class MovimentoDAO {
    ...
    public ArrayList listarTituloMovimento() throws SQLException {
        ...
        while (resultado.next()) {
            ...
            if (debugar) {
                System.out.println(lista_titulo);//teste no servidor
            }
        }
        return lista_titulo;
    }
    ...
    public ArrayList listarDescricaoMovimento() throws SQLException {
        ...
        while (resultado.next()) {
            ...
            if (debugar) {
                System.out.println(lista_descricao);//teste no servidor
            }
        }
    ...
    public ArrayList listarVencimentoMovimento() throws SQLException {
        ...
        while (resultado.next()) {
            ...
            if (debugar) {
                System.out.println(lista_vencimento);//teste no servidor
            }
        }
    ...
    public ArrayList listarValorMovimento() throws SQLException {
        ...
        while (resultado.next()) {
            ...
            if (debugar) {
                System.out.println(lista_valor);//teste no servidor
            }
        }
        return lista_valor;
    }
    ...
    public float listarSaldo() throws SQLException {
        PreparedStatement stmt = banco.prepareStatement("SELECT (( SELECT sum(valor) as Disponivel from movimentos WHERE tipo_lancamento=0)\n"
                + "-(SELECT sum(valor+0) as Disponivel from movimentos WHERE tipo_lancamento=1)) as DISPONIVEL FROM movimentos GROUP BY DISPONIVEL;");
